  ...
  return (
    <div>
      <section
        ...
        className="h-[50vh] w-full px-12"
      >
        <div className="flex flex-col items-center justify-center pt-36">
          <div className="flex justify-center items-center text-3xl md:text-5xl font-bold text-[#0B0B0B]">
            <h1>I Grow By Helping People In Need</h1>
          </div>
          <div className="flex justify-center items-center mt-10">
            <input
              onChange={(input) => setSearch(input.target.value)}
              className="bg-white border py-4 px-4 rounded-s-lg w-auto lg:w-72¸"
              type="text"
              placeholder="Search hare..."
            />
            <button
              onClick={handleClickToSearch}
              className=" px-7 text-white py-4 bg-[#FF444A] rounded-r-lg"
            >
              Search
            </button>
          </div>
